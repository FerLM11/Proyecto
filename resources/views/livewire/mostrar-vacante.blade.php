<div class="p-10">
    ...
    <div class="gap-20 md:grid md:grid-cols-6">
        <div class="md:col-span-2">
            <img src="{{asset('storage/vacantes/' . $vacante->imagen)}}" alt="{{'Imagen vacante' . $vacante->titulo}}">
        </div>
        <div class="md:col-span-4">
            <h2 class="text-2xl font-bold ">Descripcion del puesto:</h2>
    ...
    @guest
        <div class="p-5 mt-5 text-center border border-dashed bg-gray-50">
            <p>
                Deseas aplicar a esta vacante? <a class="font-bold text-cyan-600" href="{{route('register')}}">Obten una cuenta y aplica a esta y mas vacantes</a>
            </p>
        </div>
    @endguest
